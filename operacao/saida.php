...
//    $contaDest = $_POST['contaDest'];
    ...
    if ($valid) {
        ...
        $q = $pdo->prepare($sql);
        $q->execute(array($conta, $categoria, 'S', $descricao, $valor, $dataOperacao));
...
<body>
    <div class="container">
        ...
        <form class="form-horizontal" name="form1" action="saida.php" method="post" enctype="multipart/form-data">
